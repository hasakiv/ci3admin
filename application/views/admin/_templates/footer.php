...
?>
            ...
            <footer class="main-footer">
                ...
                <strong><?php echo lang('footer_copyright'); ?> &copy; 2014-<?php echo date('Y'); ?> <a href="#" target="_blank">TAKADA</a> &amp; <a href="#" target="_blank">TOKODA</a>.</strong> <?php echo lang('footer_all_rights_reserved'); ?>.
            </footer>
        </div>
