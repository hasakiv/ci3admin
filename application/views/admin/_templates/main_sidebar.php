                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="<?=active_link_controller('posts')?>">
                            <a href="<?php echo site_url('admin/posts'); ?>">
                                <i class="fa fa-dashboard"></i> <span><?php //echo lang('menu_dashboard'); ?>Bài viết</span>
                            </a>
                        </li>

                        <li class="<?=active_link_controller('category')?>">
                            <a href="<?php echo site_url('admin/category'); ?>">
                                <i class="fa fa-dashboard"></i> <span><?php //echo lang('menu_dashboard'); ?>Chuyên mục</span>
                            </a>
                        </li>
                        <li class="<?=active_link_controller('files')?>">
                            <a href="<?php echo site_url('admin/files'); ?>">
                                <i class="fa fa-file"></i> <span>
                                    <?php //echo lang('menu_files'); ?>Media</span>
                            </a>
                        </li>
